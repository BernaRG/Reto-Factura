...
<template>
    ...
    <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-white-100 dark:bg-dots-lighter  selection:bg-red-500 selection:text-red-200">
        <div>
            <img  src="/img/factu.png" class="object-cover w-20 h-24 ml-20" >
